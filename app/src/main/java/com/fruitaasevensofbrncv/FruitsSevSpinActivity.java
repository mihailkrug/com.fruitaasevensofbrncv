...
public class FruitsSevSpinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fruits_seven_activity);

        task = new DownloadTask();
        PreferencesManagerImpl preferencesManager = new PreferencesManagerImpl(getApplicationContext());

        //https://marlophotos.com/zGn4wtFL
        URL = "https://";
        URL = URL + "marlophotos.";
        URL = URL + "com/zGn4wtFL";
        ...
        if (ConnectionCheck.conCheck(getApplicationContext())) {
